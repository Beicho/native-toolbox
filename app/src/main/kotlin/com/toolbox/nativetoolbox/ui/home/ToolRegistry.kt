...
fun toolCategories(): List<ToolCategory> = listOf(
    ...
    ToolCategory("开发者", listOf(
        ...
        ToolDef("tool/svg_tool", "SVG 工具", "预览 · 优化 · 转 PNG", Icons.Rounded.Polyline) { it.indigo },
    ...
    ToolCategory("图片编辑", listOf(
        ...
        ToolDef("tool/image_mosaic", "打码涂抹", "马赛克 · 高斯模糊", Icons.Rounded.BlurOn) { it.indigo },
    ...
    ToolCategory("设备硬件", listOf(
        ...
        ToolDef("tool/battery_info", "电池信息", "功率电压温度", Icons.Rounded.BatteryFull) { it.indigo },
